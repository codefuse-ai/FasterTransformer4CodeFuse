    ...
    for (int ite = 0; ite < iteration_num; ite++) {
        ...
        for (int l = 0; l < num_layer_; l++) {
            ...
            invokeGeneralLayerNorm(decoder_normed_input_,
                                   ...
                                   h_token_num,
                                   hidden_units_,
                                   const_cast<float*>(gpt_decoder_layer_weight->at(l)->self_attention_weights.query_weight.scale),
                                   int8_mode_,
                                   stream_);
            ...
            if (is_final == false) {
                if (use_gptj_residual_) {
                    invokeGeneralLayerNorm(decoder_normed_input_,
                                           ...
                                           h_token_num,
                                           hidden_units_,
                                           const_cast<float*>(gpt_decoder_layer_weight->at(l)->ffn_weights.intermediate_weight.scale),
                                           int8_mode_,
                                           stream_);
                }
                else {
