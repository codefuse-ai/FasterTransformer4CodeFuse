...
std::vector<Tensor> symmetric_quantize_last_axis_of_batched_matrix_int8(Tensor weight)
{
    return symmetric_quantize_helper(weight, torch::kInt8, false);
}
...
PYBIND11_MODULE(libth_common, module)
{
    module.def("symmetric_quantize_last_axis_of_batched_matrix_int8",
               &torch_ext::symmetric_quantize_last_axis_of_batched_matrix_int8,
               "symmetric_quantize_last_axis_of_batched_matrix_int8");
}
#else
